...
P = readmatrix("C:\Users\xipeng\Downloads\L1-Tree-main\Data\tree_7.txt"); % Read point cloud data in txt format
...
toc
% save skeleton data
save('C:\Users\xipeng\Downloads\L1-Tree-main\Results\skeleton_7.txt', 'final_result', '-ascii');
